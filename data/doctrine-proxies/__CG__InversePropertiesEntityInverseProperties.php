 ...
 */
class InverseProperties extends \InverseProperties\Entity\InverseProperties implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'owner', 'p1', 'p2', 'created', 'modified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InverseProperties $proxy) {
